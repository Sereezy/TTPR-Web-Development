...
*/
function sliceString(preSlicedString) {
  return preSlicedString.slice(0, 140);
}
...
const sentence =
  "JavaScript lets you create websites and solve real-world problems. Practice regularly to improve. Keep learning, stay curious, and enjoy the coding journey every day.";
